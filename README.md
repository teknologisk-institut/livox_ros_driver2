...
### 1.1 OS requirements
  ...
  * Ubuntu 22.04 for ROS2 Humble, Iron and Rolling;
...
```shell
git clone https://github.com/teknologisk-institut/livox_ros_driver2 ws_livox/src/livox_ros_driver2
```
